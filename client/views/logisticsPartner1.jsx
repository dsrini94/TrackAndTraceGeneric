      ...
      <div>
        ...
        <Grid.Row>
          ...
          <center>  <Header as='h1' style={{marginTop:'100px'}}><span className="headers" style={{color:'#0e1e7a'}}>Logistics Partner</span></Header></center>
            <br/>
            <Image src ='https://www.internationaltrucks.com/-/media/navistar/trucks/spotlight/home-page/new-vocation-slider-images/durastar_localdelivery_m_2x_750x520.png?h=520&w=750&la=en&hash=6EAF6988B872EA8B2EC55EBC283654F0B78F7962' />
          </Grid.Column>
          <Grid.Column width={8}>
        ...
        <Modal size='large' open={this.state.open} onClose={this.close}>
            ...
            <br/>
              ...
              <span>Product Route :</span><br/>
                ...
                <span>7th Jan 2018,Sun  |Rainbow Chicken Logistics| 3QJmV3qfvL4SuXo34YihAf3sRCW3qSipgC</span><br/>
                </div>
            </Modal.Content>
            <Modal.Actions>
